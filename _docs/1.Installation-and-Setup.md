...
You can install this package via [Composer](http://getcomposer.org/) by running this command: `composer require toby1991/log-viewer`.
...
Go to `http://{your-project}/log-viewer` (See the [Configuration](https://github.com/toby1991/LogViewer/wiki/3.-Configuration) page to change the uri and other stuff).
